...
HDRS = ctcp_linked_list.h ctcp_utils.h ctcp.h ctcp_sys.h ctcp_sys_internal.h ctcp_bbr.h
# Add any source files you've added here.
SRCS = ctcp_linked_list.c ctcp_utils.c ctcp.c ctcp_sys_internal.c ctcp_bbr.c
